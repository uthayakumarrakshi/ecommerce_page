      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-section">
          <h2 onClick={() => toggleSection('cards')} className="section-header">
            Key Metrics <span className={`arrow ${openSections.cards ? 'open' : ''}`}>▼</span>
          </h2>
          {openSections.cards && (
        ...
        <div className="dashboard-grid">
          <div className="dashboard-section">
            <h2 onClick={() => toggleSection('sales')} className="section-header">
              Sales Overview <span className={`arrow ${openSections.sales ? 'open' : ''}`}>▼</span>
            </h2>
            {openSections.sales && (
          ...
          <div className="dashboard-section">
            <h2 onClick={() => toggleSection('topProducts')} className="section-header">
              Top Selling Products <span className={`arrow ${openSections.topProducts ? 'open' : ''}`}>▼</span>
            </h2>
          ...
          <div className="dashboard-section">
            <h2 onClick={() => toggleSection('recentOrders')} className="section-header">
              Recent Orders <span className={`arrow ${openSections.recentOrders ? 'open' : ''}`}>▼</span>
            </h2>
          ...
          <div className="dashboard-section">
            <h2 onClick={() => toggleSection('lowStock')} className="section-header">
              Low Stock Alert <span className={`arrow ${openSections.lowStock ? 'open' : ''}`}>▼</span>
            </h2>
